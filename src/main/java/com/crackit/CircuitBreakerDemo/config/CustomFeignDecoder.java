...
import com.crackit.CircuitBreakerDemo.exception.AddressServiceException;
...
public class CustomFeignDecoder implements ErrorDecoder {
    ...
    public Exception decode(String s, Response response) {
        AddressServiceException ex = formatAddressServiceException(response);
    ...
    private AddressServiceException formatAddressServiceException(Response response) {
        AddressServiceException ex = null;
        Reader reader = null;
        try {
            ...
            ex = objectMapper.readValue(result, AddressServiceException.class);
        } catch (IOException e) {
